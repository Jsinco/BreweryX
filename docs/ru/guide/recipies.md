...
!!! warning ""
    Необязательное значение, по дефолту - `0`
...
!!! warning ""
    Необязательное значение, дефолтное значение - `WHITE`
...
!!! warning ""
    Необязательное значение, дефолтное значение - `0`
...
!!! warning ""
    Необязательное значение, дефолтное значение - `false`
