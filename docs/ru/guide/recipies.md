...
| --------- | ----- | ------------- |
|Да|`Название плохого напитка/Название нормального напитка/Название хорошего напитка`|Нет|
...
| Обязательно? | Значение | Дефолтное значение |
| --------- | ----- | ------------- |
|Да|`- НазваниеПредмета/ЕгоКоличество`|Нет|
...
| Обязательно? | Значение | Дефолтное значение |
| --------- | ----- | ------------- |
|Нет|Аналогия с названием - `CMD плохого напитка/CMD нормального напитка/CMD хорошего напитка`|Нет|
